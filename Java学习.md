...
- ![图片描述](https://md-file-zhaowei.oss-cn-beijing.aliyuncs.com/Java%E5%AD%A6%E4%B9%A0/1746486842728.jpg?Expires=1746487298&OSSAccessKeyId=TMP.3KmTBcrL4L7KubUXvVc74agDrM2MZxLVCqAopUy4nx59ui2Nya9rLYGYoz9aDz3Nt4mfSkobaNnHNnEDDhsejw1LennL6y&Signature=%2BENGhXCmf%2FAXJ3TDt1ZV7jqef9w%3D)
...
**单例模式** 就是指项目中只能有一个实例，单例类只能有一个实例，且单例类必须自己创建自己的唯一实例，同时单例类必须给所有其他对象提供可以获取这一实例的方法。实现方式有多种分别为饿汉类、懒汉类、以及双重锁等等，以下为双重锁的实现方式。
